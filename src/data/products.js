export const products = [
  ...
  { id: 2, category: 'Our Set', isFeatured: true, title: 'Complete Set', desc: 'Everything you need for a perfect moment', price: 'Rp 165.000', priceValue: 165000, images: ['/assets/images/product katalog/complete set1.jpg', '/assets/images/product katalog/complete set2.JPG', '/assets/images/product katalog/complete set3.JPG', '/assets/images/product katalog/complete set4.JPG'] },
  { id: 3, category: 'Our Set', isFeatured: false, title: 'BBQ Set 1', desc: 'Grill outdoors with your loved ones', price: 'Rp 85.000', priceValue: 85000, images: ['/assets/images/product katalog/bbq set 1.jpg', '/assets/images/product katalog/bbqset 12.jpg'] },
  { id: 4, category: 'Our Set', isFeatured: false, title: 'BBQ Set 2', desc: 'Compact grilling setup', price: 'Rp 65.000', priceValue: 65000, images: ['/assets/images/product katalog/bbq set 2.jpg'] },
  { id: 5, category: 'Our Set', isFeatured: true, title: 'Chill on the Sun Set', desc: 'Enjoy the golden hour effortlessly', price: 'Rp 300.000', priceValue: 300000, images: ['/assets/images/product katalog/middle set1.jpg', '/assets/images/product katalog/middle set2.jpg', '/assets/images/product katalog/middle set3.JPG'] },
  { id: 6, category: 'Our Set', isFeatured: false, title: 'Chill on the Sun Set 2', desc: 'A cozy sunset experience', price: 'Rp 180.000', priceValue: 180000, images: ['/assets/images/product katalog/simple set1.jpg', '/assets/images/product katalog/simple set2.jpg'] },
  { id: 7, category: 'Our Set', isFeatured: false, title: 'Dessert Corner', desc: 'A sweet setup for sweet moments', price: 'Rp 100.000', priceValue: 100000, images: ['/assets/images/product katalog/teatime set1.jpg', '/assets/images/product katalog/teatime.jpg'] },
  { id: 8, category: 'Our Set', isFeatured: true, title: 'Indoor Movie Set', desc: 'Bring the cinema to your space', price: 'Rp 250.000', priceValue: 250000, images: ['/assets/images/product katalog/image (1).png', '/assets/images/product katalog/image.png'] },
  { id: 33, category: 'Our Set', isFeatured: false, title: 'Parisian Set', desc: 'A touch of Paris in your picnic', price: 'Rp 200.000', priceValue: 200000, images: ['/assets/images/product katalog/parisian set1.jpg', '/assets/images/product katalog/parisian set2.JPG'] },
  ...
  { id: 15, category: 'Additional Items', isFeatured: false, title: 'Mini Table 15x30cm', desc: 'Small table for your snacks', price: 'Rp 15.000', priceValue: 15000, images: ['/assets/images/product katalog/IMG_0494.JPG'] },
  { id: 16, category: 'Additional Items', isFeatured: false, title: 'Mini Table 30x50cm', desc: 'Medium table for your setups', price: 'Rp 30.000', priceValue: 30000, images: ['/assets/images/product katalog/IMG_0498.JPG'] },
  { id: 35, category: 'Additional Items', isFeatured: false, title: 'Vintage Mirror', desc: 'Aesthetic vintage mirror', price: 'Rp 20.000', priceValue: 20000, images: ['/assets/images/product katalog/IMG_0498.JPG'] },
  { id: 36, category: 'Additional Items', isFeatured: false, title: 'Yellow Cushion', desc: 'Comfortable yellow cushion', price: 'Rp 15.000', priceValue: 15000, images: ['/assets/images/product katalog/IMG_0499.JPG'] },
  { id: 37, category: 'Additional Items', isFeatured: false, title: 'Glass Pitcher Set', desc: 'Pitcher with two glasses', price: 'Rp 25.000', priceValue: 25000, images: ['/assets/images/product katalog/IMG_0500.JPG'] },
  { id: 38, category: 'Additional Items', isFeatured: false, title: 'Bucket Hat Set', desc: 'Two aesthetic bucket hats', price: 'Rp 20.000', priceValue: 20000, images: ['/assets/images/product katalog/IMG_0336.JPG', '/assets/images/product katalog/IMG_0335.JPG'] },
  { id: 19, category: 'Additional Items', isFeatured: false, title: 'Bean Bag Abu Abu', desc: 'Comfortable grey bean bag', price: 'Rp 40.000', priceValue: 40000, images: ['/assets/images/product katalog/IMG_0429.JPG'] },
  { id: 20, category: 'Additional Items', isFeatured: false, title: 'Bean Bag Coklat', desc: 'Comfortable brown bean bag', price: 'Rp 40.000', priceValue: 40000, images: ['/assets/images/product katalog/IMG_0378.JPG'] }
];

export const categories = ['See All', 'Our Set', 'Board Games', 'Additional Items', 'Highlight Packages', 'Decoration Set'];
