  ...
  return (
    <section className="max-w-[1400px] mx-auto px-8 py-12" id="howitworks">
        ...
        <div className="flex flex-col md:flex-row gap-6 h-auto md:h-[400px]">
            ...
            >
                <img src="/assets/images/picnic moments in open air.JPG" alt="Picnic setup flatlay" className="absolute inset-0 w-full h-full object-cover transition duration-700 group-hover:scale-105" />
