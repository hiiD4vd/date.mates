...
const LocationFooter = () => {
  return (
    <footer className="bg-offwhite pt-24 pb-12 border-t border-orange-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          {/* Map Placeholder */}
          <div>
            <h4 className="font-serif text-2xl text-darkgrey mb-6">Find Us</h4>
            <div className="w-full h-48 bg-white rounded flex items-center justify-center border border-orange-100 shadow-[0_4px_20px_rgba(139,69,19,0.05)]">
          ...
          <div className="flex flex-col justify-between md:items-end md:text-right">
             <div className="mb-8 md:mb-0">
               <a href="#" className="inline-block mb-4">
                  <img src="/assets/logo/datemates logo transparent.png" alt="date.mates logo" className="h-10 object-contain" />
               </a>
        ...
        <div className="pt-8 border-t border-orange-100 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400">
