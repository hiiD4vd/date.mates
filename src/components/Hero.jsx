  ...
  return (
    <section className="relative w-full h-screen min-h-[800px] flex items-center overflow-hidden bg-white">
      ...
      <motion.div 
        ...
        style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1544148103-0773bf10d330?auto=format&fit=crop&w=2000&q=80")' }}
      >
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col justify-end h-full pb-32">
        <div className="max-w-4xl text-center md:text-left mx-auto md:mx-0">
          ...
          >
            <a href="#packages" className="bg-rose-200 text-gray-900 text-sm font-semibold rounded-full px-8 py-3.5 hover:bg-rose-300 transition-colors shadow-lg">
              Book Your Date
            </a>
          </motion.div>
        </div>
      ...
      >
        <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-darkgrey hover:bg-rose-200 transition-colors shadow-md">
